		...
		private void btnSale_Click(object sender, RoutedEventArgs e)
		{
			gridFirst.Dispatcher.Invoke(() =>
			{
				...
				var newTicket = new Ticket
				{
					...
					Src = (from cities in dataContext.Cities where cities.Name == comboBoxSource.Text select cities.Id).First(),
					Dst = (from cities in dataContext.Cities where cities.Name == comboBoxDestination.Text select cities.Id).First(),
					Class = comboBoxClass.Text,
					Date1 = (DateTime) dateDeparture.SelectedDate,
					Date2 = (DateTime) dateArrival.SelectedDate,
				...
				MessageBox.Show("The ticket was added");
